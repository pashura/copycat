...
class TestAtLeastOneOfValidator:
    ...
    @patch('copy_cat.core.validators.validation_conditions.at_least_one_of_validator.ErrorsGenerator.generate')
    ...
    @patch('copy_cat.core.validators.validation_conditions.at_least_one_of_validator.get_successful_conditions_count')
