...
from copy_cat.validators.validation_conditions import AtLeastOneOfValidator
...
class TestAtLeastOneOfValidator:
    ...
    @patch('copy_cat.validators.validation_conditions.at_least_one_of_validator.ErrorsGenerator.generate')
    ...
    @patch('copy_cat.validators.validation_conditions.at_least_one_of_validator.get_successful_conditions_count')
    def test__conditions_satisfied_returns_false_when_count_is_zero(self, mock_get_successful_conditions_count):
    ...
    @patch('copy_cat.validators.validation_conditions.at_least_one_of_validator.get_successful_conditions_count')
    def test__conditions_satisfied_returns_true_when_count_bigger_than_zero(self, mock_get_successful_conditions_count):
