...
from copy_cat.validators.validation_conditions import IfOneThenAllValidator
...
class TestIfOneThenAllValidator:
    ...
    @patch('copy_cat.validators.validation_conditions.if_one_then_all_validator.ErrorsGenerator.generate')
    ...
    @patch('copy_cat.validators.validation_conditions.if_one_then_all_validator.get_successful_conditions_count')
