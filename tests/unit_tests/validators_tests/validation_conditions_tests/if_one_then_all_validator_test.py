...
class TestIfOneThenAllValidator:
    ...
    @patch(
        "copy_cat.core.validators.validation_conditions.if_one_then_all_validator.ErrorsGenerator.generate"
    )
    ...
    @patch(
        "copy_cat.core.validators.validation_conditions.if_one_then_all_validator.get_successful_conditions_count"
    )
    def test__conditions_satisfied_returns_true_when_count_is_zero(
    ...
    def test__conditions_satisfied_returns_true_when_count_equals_len(
        self, mock_get_successful_conditions_count
    ):
