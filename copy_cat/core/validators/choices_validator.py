...
class ChoicesValidator(AbstractValidator):
    ...
    def _validate_choices(self, design_object: DesignObject, test_data_object: DataObject) -> None:
        ...
        if design_object.restriction.display_name == 'StringSet':
            ...
            if test_data_object.value not in qualifiers and not design_object.restriction.drop_extra_records:
